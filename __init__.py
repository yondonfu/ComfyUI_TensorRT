from .modelopt_nodes import NODE_CLASS_MAPPINGS as MO_CLASS_MAP
from .modelopt_nodes import NODE_DISPLAY_NAME_MAPPINGS as MO_NAME_MAP
...
NODE_CLASS_MAPPINGS = TRT_CLASS_MAP | ONNX_CLASS_MAP | MO_CLASS_MAP
NODE_DISPLAY_NAME_MAPPINGS = TRT_NAME_MAP | ONNX_NAME_MAP | MO_NAME_MAP
